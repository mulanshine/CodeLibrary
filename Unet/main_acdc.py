...
def run_main():
    ...
    parser.add_argument('--trainlist', default="/root/chujiajia/Code/ACDC_CF/libs/datasets/jsonLists/acdcList/Dense_TrainValList.json")
    ...
    parser.add_argument('--loss_term', type=str, default='contour')

    parser.add_argument('--initial_lr', type=float, default=0.0001)
    parser.add_argument('--resultpath', type=str, default="/root/chujiajia/Results/")
    parser.add_argument('--experiment_name', type=str,default='bz16_contour_loss_acdc_1e4_epoch150')
    parser.add_argument('--num_workers', default=16, type=int)
    parser.add_argument('--model_path', default="/root/chujiajia/Results/new_dice_loss_acdc_3/CP_Best.pth", type=str)
