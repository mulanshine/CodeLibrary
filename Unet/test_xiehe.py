...
def run_main():
    ...
    parser.add_argument('--trainlist', default="/root/chujiajia/Code/ACDC_CF/libs/datasets/jsonLists/train_50000.json")
    parser.add_argument('--testlist', default="/root/chujiajia/Code/ACDC_CF/libs/datasets/jsonLists/test_50000.json")
    ...
    parser.add_argument('--experiment_name', type=str,default='dice_loss_acdc_1')
    ...
    for epoch in range(1, args.num_epochs + 1):
        ...
        if  epoch > 0 and epoch % 10 == 0:
            ...
            # mean_dice = valiation_structure(model,args,"mr_test",imgsavepath,logpath)
            mean_dice = valiation_structure(model,args,logpath,testloader,imgsavepath)
